		...
		var list = new Scalr.Viewers.ListView({
			...
			listViewOptions: {
				...
				columns: [
					...
					{ header: "Time", width: 25, dataIndex: 'time', sortable: false, hidden: 'no' },
					{ header: "Farm", width: 25, dataIndex: 'farm_name', sortable: false, hidden: 'no', tpl:
						"<a href='#/farms/{farmid}/view'>{farm_name}</a>"
					},
					{ header: "Caller", width: 40, dataIndex: 'source', sortable: false, hidden: 'no', tpl:
						"<a href='#/servers/{servername}/view'>{servername}</a>/{source}"
					},
					{ header: "Message", width: 160, dataIndex: 'message', sortable: false, hidden: 'no', tpl:
