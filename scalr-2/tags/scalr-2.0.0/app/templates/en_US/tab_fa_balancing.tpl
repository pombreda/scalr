				...
				store: LBListenersStore,
   		        ...
   		        columns: [
					...
					'&nbsp;',
					{
         			    ...
         			    handler: function() 
         			    {
          	            	var lb_val = Ext.get('lb.bbar.lb_port').dom.value;
							...
							var is_val = Ext.get('lb.bbar.i_port').dom.value; 
							...
							var recordData = {
         	            		protocol:Ext.get('lb.bbar.proto').dom.value,
         	            		lb_port:lb_val, 
							...
							Ext.get('lb.bbar.proto').dom.value = 'TCP';
							Ext.get('lb.bbar.lb_port').dom.value = '';
							Ext.get('lb.bbar.i_port').dom.value = '';
