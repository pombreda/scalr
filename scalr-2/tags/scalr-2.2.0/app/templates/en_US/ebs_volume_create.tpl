{include file="inc/header.tpl"}
	{include file="inc/table_header.tpl"}
		...
		{else}
	    	...
	    	<tr>
	    		<td><input onclick="Ext.get('ebs_size').dom.disabled = !this.checked; Ext.get('snapId').dom.disabled = this.checked;" type="radio" name="ctype" checked value="1" style="vertical-align:middle;"> Create empty volume with size:</td>
	    		<td><input type="text" name="size" id="ebs_size" value="" class="text" size="3"> GB</td>
	    	</tr>
	    	<tr>
	    		<td><input onclick="Ext.get('ebs_size').dom.disabled = this.checked; Ext.get('snapId').dom.disabled = !this.checked;" type="radio" {if $snapId}checked{/if} name="ctype" value="2" style="vertical-align:middle;"> Create volume from snapshot:</td>
	    		<td>
