<?php
	...
	class Scalr_Service_Cloud_RackspaceCS extends Scalr_Service_Cloud_Rackspace_Connection
	{
        ...
        * @return mixed $response
        */
        public function createServer($argsArray, $personality = null )
        {
		...
		*/
		 ...
		 * @return  mixed $response
		 */
		public function listServers($detail = null)
		{
			if($detail)
    			$detail = "/detail"; 
    			
			 return $this->request("GET","servers{$detail}");
		}
