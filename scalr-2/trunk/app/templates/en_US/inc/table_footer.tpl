			...
			<div class="WebtaTable_Footer" id="footer_button_table" style="padding-left:6px;padding-top:2px; padding-bottom:2px;">
				...
				{/if}
				{if $next_page}
						<input type="submit" style="margin-right:6px;vertical-align:middle;" class="btn" name="next" value="Next" />	
				{/if}
				{if $button_js}
				...
				{/if}
				{if $cancel_btn}
						<input type="submit" class="btn" style="margin-right:6px;vertical-align:middle;" name="cancel" value="Cancel" />&nbsp;
				{/if}
				{if $retry_btn}
						<input type="button" style="margin-right:6px;vertical-align:middle;" class="btn" name="retrybtn" value="Retry" onclick="window.location=get_url;return false;" />	
				{/if}
	                     {if $backbtn}
						<input type="submit" style="margin-right:6px;vertical-align:middle;" class="btn" name="cbtn_3" value="Back" onclick="history.back();return false;" />	
				{/if}
				{if $loader}
