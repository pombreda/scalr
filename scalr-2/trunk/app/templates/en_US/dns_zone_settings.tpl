{include file="inc/header.tpl"}
	...
	{include file="inc/table_header.tpl"}
		...
		<tr>
			<td colspan="2">	
				<input style="vertical-align:middle;" name="allow_manage_system_records" type="checkbox" {if $allow_manage_system_records}checked="checked"{/if} id="allow_manage_system_records" value="1" /> 
				Allow me to edit system records.					
			</td>
		</tr>		
