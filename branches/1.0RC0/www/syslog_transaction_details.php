<? 
	...
	if ($get_trnid)
		...
		$display["rows"] = $db->GetAll("SELECT *, transactionid as sub_transactionid FROM syslog WHERE sub_transactionid=? ORDER BY dtadded_time ASC, id ASC", array($get_strnid));
