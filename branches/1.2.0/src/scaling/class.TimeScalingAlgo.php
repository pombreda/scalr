<?
	...
	{		
		...
		{			
			...
			$sensor_value = $TimeSensor->GetValue($DBFarmRole);
			$this->Logger->info("TimeScalingAlgo({$DBFarmRole->FarmID}, {$DBFarmRole->AMIID}) Sensor returned value: ".serialize($sensor_value).".");
