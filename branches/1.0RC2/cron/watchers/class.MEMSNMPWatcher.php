<?
    ...
    class MEMSNMPWatcher
    {
        ...
        {            
            ...
            $this->RRD->AddDS(new RRDDS("total", "GAUGE", 180));
            $this->RRD->AddDS(new RRDDS("avail", "GAUGE", 180));
            $this->RRD->AddDS(new RRDDS("free", "GAUGE", 180));
            $this->RRD->AddDS(new RRDDS("shared", "GAUGE", 180));
            $this->RRD->AddDS(new RRDDS("buffer", "GAUGE", 180));
            $this->RRD->AddDS(new RRDDS("cached", "GAUGE", 180));
        ...
        {                              
            ...
            // Add data to rrd
            //    
            preg_match_all("/[0-9]+/si", $this->SNMPTree->Get(".1.3.6.1.4.1.2021.4.3.0"), $matches);
            $MEMSwap = $matches[0][0];
                                    
            preg_match_all("/[0-9]+/si", $this->SNMPTree->Get(".1.3.6.1.4.1.2021.4.4.0"), $matches);
            $MEMSwapAvail = $matches[0][0];
            
            preg_match_all("/[0-9]+/si", $this->SNMPTree->Get(".1.3.6.1.4.1.2021.4.5.0"), $matches);
            $MEMTotal = $matches[0][0];
            
            preg_match_all("/[0-9]+/si", $this->SNMPTree->Get(".1.3.6.1.4.1.2021.4.6.0"), $matches);
            $MEMAvail = $matches[0][0];
			
            preg_match_all("/[0-9]+/si", $this->SNMPTree->Get(".1.3.6.1.4.1.2021.4.11.0"), $matches);
            $MEMFree = $matches[0][0];
            
            preg_match_all("/[0-9]+/si", $this->SNMPTree->Get(".1.3.6.1.4.1.2021.4.13.0"), $matches);
            $MEMShared = $matches[0][0];
            
            preg_match_all("/[0-9]+/si", $this->SNMPTree->Get(".1.3.6.1.4.1.2021.4.14.0"), $matches);
            $MEMBuffer = $matches[0][0];
            
            preg_match_all("/[0-9]+/si", $this->SNMPTree->Get(".1.3.6.1.4.1.2021.4.15.0"), $matches);
            $MEMCached = $matches[0][0];
