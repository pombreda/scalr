...
function EditTemplate(templateName, dirName, aNode)
{
    ...
    new Ajax.Request('/server/tmanager.php', {
...
<table width="100%" cellpadding="0" cellspacing="0" height="100%">
    <tr valign="top">
        <td width="30%">
            ...
            {include file="inc/intable_header.tpl" header="Templates" color="Gray"}
    	       <tr>
    	           <td>
        		...
        		<tr valign="top" style="height:10px;">
        			<td valign="middle">
        				<span style="vertical-align:middle;">
        					<a href="?dir={$folders[id].name}&cd={$folders[id].curdir}"><img style="vertical-align:middle;" border="0" src="/images/folder.gif"></a> <a href="?dir={$folders[id].name}&cd={$folders[id].curdir}">{$folders[id].name}</a>
        				</span>
        			</td>
        		</tr>
        	{/section}
        		...
        		<tr valign="top" style="height:10px;">
        			<td valign="middle" style="width:100%">
        				<div id="ff_{$smarty.section.id.iteration}" style="vertical-align:middle; width:290px;;padding:1px;border:1px solid #F4F4F4">
        					<a href="#" onclick="EditTemplate('{$files[id].name}', '{$dir}', 'ff_{$smarty.section.id.iteration}');"><img style="vertical-align:middle;" border="0" alt="{$files[id].type} template file" src="/images/{$files[id].image}.gif"></a> <a href="#" onclick="EditTemplate('{$files[id].name}', '{$dir}', 'ff_{$smarty.section.id.iteration}');">{$files[id].name}</a>
        				</div>
        			</td>
        		</tr>
        	{/section}   
    	...
    	<td width="68%" id="templ_area" style="display:none;">
    	   ...
    	   <form action="templates_manager.php?file={$file}" method="post">
    	       {include file="inc/intable_header.tpl" header="" color="Gray" header_id="edit"}
    	       <tr>
    	           <td width="100%">
        	   ...
        	   {include file="inc/intable_footer.tpl" color="Gray"}
    	   {include file="inc/table_footer.tpl" button_js=1 button_js_name="Save" button_js_action="SaveTemplate();"}
    	</td>
    </tr>
</table>	
