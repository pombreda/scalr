...
var hljs = new function() {
  ...
  var DEFAULT_LANGUAGES = ['php', 'python', 'ruby', 'perl', 'css', 'xml', 'html', 'django', 'javascript', 'java', 'cpp', 'cs', 'sql', 'ini', 'diff'];
  ...
  function highlightBlock(block) {
    ...
    if (result) {
      ...
      container.innerHTML = '<pre style="margin:0px;"><code class="' + className + '">' + result + '</code></pre>';
