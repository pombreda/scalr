...
// Methods
	...
	*/
	...
	onMove2: function() {
		...
		this.gebi(this.CENTER_BLOCK_PREFIX+this.id).removeClassName('trackbar_red');
		this.gebi(this.CENTER_BLOCK_PREFIX+this.id).removeClassName('trackbar_yellow');
		this.gebi(this.CENTER_BLOCK_PREFIX+this.id).removeClassName('trackbar_normal');
		
		if (delta <= 1)
		{
			this.gebi(this.CENTER_BLOCK_PREFIX+this.id).addClassName('trackbar_red');
		}
		else if (delta < 2)
		{
			this.gebi(this.CENTER_BLOCK_PREFIX+this.id).addClassName('trackbar_yellow');
		}
		else if (delta >= 2)
		{
			this.gebi(this.CENTER_BLOCK_PREFIX+this.id).addClassName('trackbar_normal');
		}
