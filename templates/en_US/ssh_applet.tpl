...
<title>SSH console on instance: {$i.instance_id} &nbsp; IP: {$i.external_ip} &nbsp; Internal IP: {$i.internal_ip}</title>
</head>
<body>
	<div style="margin-top:22px;margin-bottom:38px;font-weight:bold;font-size:10pt;font-family:Verdana;">SSH console on instance: {$i.instance_id} &nbsp; IP: {$i.external_ip} &nbsp; Internal IP: {$i.internal_ip}</div>
