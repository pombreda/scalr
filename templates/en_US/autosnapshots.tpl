{include file="inc/header.tpl"}
	{include file="inc/table_header.tpl"}
		...
		<tr>
    		<td><input {if $auto_snap}checked{/if} onclick="if (this.checked) $('autosnaps_settings').style.display = ''; else $('autosnaps_settings').style.display = 'none';" type="checkbox" name="enable" value="1" style="vertical-align:middle;"> Enable auto-snapshots</td>
    		<td></td>
    	</tr>
    	<tr>
    		<td colspan="2">&nbsp;</td>
