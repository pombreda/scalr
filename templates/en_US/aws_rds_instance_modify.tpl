    	...
    	<tr>
    		...
    		<td>
    			<select name="DBParameterGroupName" class="text">
    				...
    				<option {if $instance->DBParameterGroups->DBParameterGroup->DBParameterGroupName == $DBParameterGroups[id]->DBParameterGroupName}selected{/if} value="{$DBParameterGroups[id]->DBParameterGroupName}">{$DBParameterGroups[id]->DBParameterGroupName}</option>
    				{/section}
    			</select>
    		</td>
    	</tr>
